...
import {
  IUserAttributeControllerCreateUserAttributeOutputError as IControllerError,
  IUserAttributeControllerCreateUserAttributeOutputSuccess as IControllerSuccess,
...
/**
 * @name					userAttributeRouterCreateUserAttribute
 *
 * @description		The 'createUserAttribute' router for 'userAttribute', whose expected
 *                inputs have been defined within the following schema:
 *                'userAttributeValidationSchemaCreateUserAttribute'.
 *
...
export const userAttributeRouterCreateUserAttribute = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'userAttributeValidationSchemaCreateUserAttribute'.
      ...
      const stat = await userAttributeController.createUserAttribute(validatedParams);
