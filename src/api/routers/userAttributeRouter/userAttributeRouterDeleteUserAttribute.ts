...
import {
  IUserAttributeControllerDeleteUserAttributeOutputError as IControllerError,
  IUserAttributeControllerDeleteUserAttributeOutputSuccess as IControllerSuccess,
...
/**
 * @name					userAttributeRouterDeleteUserAttribute
 *
 * @description		The 'deleteUserAttribute' router for 'userAttribute', whose expected
 *                inputs have been defined within the following schema:
 *                'userAttributeValidationSchemaDeleteUserAttribute'.
 *
 ...
 *                | Server error                | 500               |
 */
export const userAttributeRouterDeleteUserAttribute = Router(options).delete(
  '/',
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'userAttributeValidationSchemaDeleteUserAttribute'.
      ...
      const stat = await userAttributeController.deleteUserAttribute(validatedParams);
       ...
       * 'userAttributeId' from 'stat.payload' and return
      ...
      res
        ...
        .send({ userAttributeId: controllerResponsePayload['userAttributeId'] });
    } catch (error) {
      /*
