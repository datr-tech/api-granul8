...
import {
  IUserAttributeControllerUpdateUserAttributeOutputError as IControllerError,
  IUserAttributeControllerUpdateUserAttributeOutputSuccess as IControllerSuccess,
...
/**
 * @name					userAttributeRouterUpdateUserAttribute
 *
 * @description		The 'updateUserAttribute' router for 'userAttribute', whose expected
 *                inputs have been defined within the following schema:
 *                'userAttributeValidationSchemaUpdateUserAttribute'.
 *
...
export const userAttributeRouterUpdateUserAttribute = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'userAttributeValidationSchemaUpdateUserAttribute'.
      ...
      const stat = await userAttributeController.updateUserAttribute({
        userAttributeId,
        payload,
      });
