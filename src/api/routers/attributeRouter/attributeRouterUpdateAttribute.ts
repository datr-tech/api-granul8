...
import {
  IAttributeControllerUpdateAttributeOutputError as IControllerError,
  IAttributeControllerUpdateAttributeOutputSuccess as IControllerSuccess,
...
/**
 * @name					attributeRouterUpdateAttribute
 *
 * @description		The 'updateAttribute' router for 'attribute', whose expected
 *                inputs have been defined within the following schema:
 *                'attributeValidationSchemaUpdateAttribute'.
 *
...
export const attributeRouterUpdateAttribute = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'attributeValidationSchemaUpdateAttribute'.
      ...
      const stat = await attributeController.updateAttribute({ attributeId, payload });
