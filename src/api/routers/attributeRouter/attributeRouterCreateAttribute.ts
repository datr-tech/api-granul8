...
import {
  IAttributeControllerCreateAttributeOutputError as IControllerError,
  IAttributeControllerCreateAttributeOutputSuccess as IControllerSuccess,
...
/**
 * @name					attributeRouterCreateAttribute
 *
 * @description		The 'createAttribute' router for 'attribute', whose expected
 *                inputs have been defined within the following schema:
 *                'attributeValidationSchemaCreateAttribute'.
 *
...
export const attributeRouterCreateAttribute = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'attributeValidationSchemaCreateAttribute'.
      ...
      const stat = await attributeController.createAttribute(validatedParams);
