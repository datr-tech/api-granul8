...
import {
  IResourceAttributeControllerUpdateResourceAttributeOutputError as IControllerError,
  IResourceAttributeControllerUpdateResourceAttributeOutputSuccess as IControllerSuccess,
...
/**
 * @name					resourceAttributeRouterUpdateResourceAttribute
 *
 * @description		The 'updateResourceAttribute' router for 'resourceAttribute', whose expected
 *                inputs have been defined within the following schema:
 *                'resourceAttributeValidationSchemaUpdateResourceAttribute'.
 *
...
export const resourceAttributeRouterUpdateResourceAttribute = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'resourceAttributeValidationSchemaUpdateResourceAttribute'.
      ...
      const stat = await resourceAttributeController.updateResourceAttribute({
        resourceAttributeId,
        payload,
      });
       ...
       * 'resourceAttributeId' from 'stat.payload' and return
      ...
      res
        ...
        .send({ resourceAttributeId: controllerResponsePayload['resourceAttributeId'] });
    } catch (error) {
      /*
