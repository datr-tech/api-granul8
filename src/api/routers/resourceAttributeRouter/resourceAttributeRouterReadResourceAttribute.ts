...
import {
  IResourceAttributeControllerReadResourceAttributeOutputError as IControllerError,
  IResourceAttributeControllerReadResourceAttributeOutputSuccess as IControllerSuccess,
...
/**
 * @name					resourceAttributeRouterReadResourceAttribute
 *
 * @description		The 'readResourceAttribute' router for 'resourceAttribute', whose expected
 *                inputs have been defined within the following schema:
 *                'resourceAttributeValidationSchemaReadResourceAttribute'.
 *
 ...
 *                controller, 'resourceAttributeController', which, when successful, will return
...
export const resourceAttributeRouterReadResourceAttribute = Router(options).get(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'resourceAttributeValidationSchemaReadResourceAttribute'.
       ...
       * to 'resourceAttributeController'.
       */

      const validatedParams = matchedData<IResourceAttributeModel>(req);
      const stat =
        await resourceAttributeController.readResourceAttribute(validatedParams);
       ...
       * 'resourceAttributeModel' from 'stat.payload' and return
       * it with an appropriate status code.
       */

      const { resourceAttributeModel, responseStatusCode } = (stat as IControllerSuccess)
        .payload;
      res.status(responseStatusCode).send({ resourceAttributeModel });
    } catch (error) {
      /*
