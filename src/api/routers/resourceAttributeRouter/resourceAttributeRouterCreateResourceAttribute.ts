...
import {
  IResourceAttributeControllerCreateResourceAttributeOutputError as IControllerError,
  IResourceAttributeControllerCreateResourceAttributeOutputSuccess as IControllerSuccess,
...
/**
 * @name					resourceAttributeRouterCreateResourceAttribute
 *
 * @description		The 'createResourceAttribute' router for 'resourceAttribute', whose expected
 *                inputs have been defined within the following schema:
 *                'resourceAttributeValidationSchemaCreateResourceAttribute'.
 *
...
export const resourceAttributeRouterCreateResourceAttribute = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'resourceAttributeValidationSchemaCreateResourceAttribute'.
