...
import {
  IAttributeTypeControllerDeleteAttributeTypeOutputError as IControllerError,
  IAttributeTypeControllerDeleteAttributeTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					attributeTypeRouterDeleteAttributeType
 *
 * @description		The 'deleteAttributeType' router for 'attributeType', whose expected
 *                inputs have been defined within the following schema:
 *                'attributeTypeValidationSchemaDeleteAttributeType'.
 *
 ...
 *                | Server error                | 500               |
 */
export const attributeTypeRouterDeleteAttributeType = Router(options).delete(
  '/',
  checkSchema(<Schema>attributeTypeValidationSchemaDeleteAttributeType),
  checkExact(),
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'attributeTypeValidationSchemaDeleteAttributeType'.
      ...
      const stat = await attributeTypeController.deleteAttributeType(validatedParams);
       ...
       * 'attributeTypeId' from 'stat.payload' and return
      ...
      res
        ...
        .send({ attributeTypeId: controllerResponsePayload['attributeTypeId'] });
    } catch (error) {
      /*
