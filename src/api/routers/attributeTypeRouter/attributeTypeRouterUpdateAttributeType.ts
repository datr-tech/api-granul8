...
import {
  IAttributeTypeControllerUpdateAttributeTypeOutputError as IControllerError,
  IAttributeTypeControllerUpdateAttributeTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					attributeTypeRouterUpdateAttributeType
 *
 * @description		The 'updateAttributeType' router for 'attributeType', whose expected
 *                inputs have been defined within the following schema:
 *                'attributeTypeValidationSchemaUpdateAttributeType'.
 *
...
export const attributeTypeRouterUpdateAttributeType = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'attributeTypeValidationSchemaUpdateAttributeType'.
      ...
      const stat = await attributeTypeController.updateAttributeType({
        attributeTypeId,
        payload,
      });
