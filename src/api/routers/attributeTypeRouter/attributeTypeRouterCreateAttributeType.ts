...
import {
  IAttributeTypeControllerCreateAttributeTypeOutputError as IControllerError,
  IAttributeTypeControllerCreateAttributeTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					attributeTypeRouterCreateAttributeType
 *
 * @description		The 'createAttributeType' router for 'attributeType', whose expected
 *                inputs have been defined within the following schema:
 *                'attributeTypeValidationSchemaCreateAttributeType'.
 *
...
export const attributeTypeRouterCreateAttributeType = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'attributeTypeValidationSchemaCreateAttributeType'.
      ...
      const stat = await attributeTypeController.createAttributeType(validatedParams);
