...
export const resourceAttributeControllerReadResourceAttribute: IResourceAttributeControllerReadResourceAttribute =
  async ({ resourceAttributeId }) => {
    ...
    try {
       ...
       */
      stat.error = false;
      stat.payload = { resourceAttributeModel };

      /*
       * Cast the response object to 'IResourceAttributeControllerReadResourceAttributeOutputSuccess',
       * where the casting interface is a component of the binary union type
       * 'IResourceAttributeControllerReadResourceAttributeOutput'.
       */
