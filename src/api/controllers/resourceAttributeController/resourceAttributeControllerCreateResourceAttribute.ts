...
export const resourceAttributeControllerCreateResourceAttribute: IResourceAttributeControllerCreateResourceAttribute =
  async ({
    ...
    try {
      ...
      /*
       * The save the created model to the associated store: 'db-granul8',
       */
       ...
       */
      stat.error = false;
      stat.payload = { resourceAttributeId: resourceAttributeModel.id };
       ...
       * 'IResourceAttributeControllerCreateResourceAttributeOutput'.
       */
